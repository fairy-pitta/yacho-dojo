...
### 1.2.1 データベース設計拡張（復習機能・フィルタリング機能） ✅
- [x] **データベース設計書更新**: database.mdの詳細化
  - [x] 復習機能用テーブル設計（UserQuestionStatus）
  - [x] 3色フラグシステム（赤=苦手、黄=要注意、緑=得意）
  - [x] クイズタイプ拡張（復習別、科・目フィルタ）
  - [x] 科・目での絞り込み機能設計
  - [x] インデックス設計（パフォーマンス最適化）
  - [x] 主要クエリパターンの定義
- [x] **設計方針確定**:
  - [x] 応用情報技術者試験過去問道場スタイルの復習機能
  - [x] 問題数の柔軟性（10,20,30,40,50,60問）
  - [x] 科・目での絞り込み機能（複数選択可能）
  - [x] フィルタ条件の履歴保存（JSONB）
- [x] **コミット**: `git add . && git commit -m "[データベース設計拡張]: 復習機能と科・目フィルタリング機能の詳細設計完了"`
